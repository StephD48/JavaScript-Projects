...
//This function is for placing an x or a o in a square.
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlayer is equal t0 'X' the x.png is placed in HTML.
        ...
        //This condition checks to see if the computer turns on
        if(activePlayer === 'O') {
...
//drawWinLine function is clled to draw line if condition is met.
function checkWinConditions() {
    ...
    //This condition cjecks for a tie. If none of the above conditions register and 9
    //squares are selected the code executes.
    else if (selectedSquares.length >= 9) {
        //This function playes the tie game sound.
        audio('./media/drip.mp3');
...
//This function takes astring paramenter of the path you set eariler for
